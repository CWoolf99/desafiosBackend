...
const RouterP = require("./router/routerProductos");
const graphqlSchema = require("./models/graphqlSchema")
const { getProductos , createProducto , updateProducto , deleteProducto } = require("./persistencia/graphqlProductos")
...
//api prods//////////
app.use('/api-prods' , RouterP)
//graphqlProds//////////
app.use('/graphQL-prods' , graphqlHTTP({
